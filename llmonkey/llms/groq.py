...
class GroqLlama3_1_70bVersatile(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3.1 70B Versatile hosted at Groq",
...
class GroqLlama3_1_8bInstant(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3.1 8B Instant hosted at Groq",
...
class GroqLlama3_70BToolUsePreview(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3 Groq 70B Tool Use Preview hosted at Groq",
...
class GroqLlama3_8BToolUsePreview(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3 Groq 8B Tool Use Preview hosted at Groq",
...
class GroqLlamaGuard38B(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama Guard 3 8B hosted at Groq",
...
class GroqLlama3_2_1BPreview(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3.2 1B (Preview) hosted at Groq",
...
class GroqLlama3_2_3BPreview(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3.2 3B (Preview) hosted at Groq",
...
class GroqLlama3_2_11BVisionPreview(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3.2 11B Vision hosted at Groq",
...
class GroqLlama3_2_90BPreview(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3.2 90B hosted at Groq",
...
class GroqLlama3_70B8k(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3 70B hosted at Groq",
...
class GroqLlama3_8B8k(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Llama 3 8B hosted at Groq",
...
class GroqMixtral8x7B(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Mixtral 8x7B hosted at Groq",
...
class GroqGemma7B8kInstruct(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Gemma 7B 8k Instruct hosted at Groq",
...
class GroqGemma2_9B8k(BaseLLMModel):
    config = ModelConfig(
        ...
        verbose_name="Gemma 2 9B 8k hosted at Groq",
